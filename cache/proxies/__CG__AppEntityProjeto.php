...
class Projeto extends \App\Entity\Projeto implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Projeto' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Projeto' . "\0" . 'dataInicial', '' . "\0" . 'App\\Entity\\Projeto' . "\0" . 'dataFinal', '' . "\0" . 'App\\Entity\\Projeto' . "\0" . 'idEmpresa', '' . "\0" . 'App\\Entity\\Projeto' . "\0" . 'valor', '' . "\0" . 'App\\Entity\\Projeto' . "\0" . 'projetoConsultor'];
        }
     ...
     * {@inheritDoc}
     */
    public function setIdEmpresa(\App\Entity\Empresa $idEmpresa = NULL)
    {
     ...
     * {@inheritDoc}
     */
    public function getProjetoConsultor()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getProjetoConsultor', []);

        return parent::getProjetoConsultor();
    }
