 ...
 */
class Salas extends \App\Entity\Salas implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Salas' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Salas' . "\0" . 'numero'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Salas $proxy) {
