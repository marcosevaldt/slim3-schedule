...
class Usuarios extends \App\Entity\Usuarios implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Usuarios' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Usuarios' . "\0" . 'email', '' . "\0" . 'App\\Entity\\Usuarios' . "\0" . 'senha', '' . "\0" . 'App\\Entity\\Usuarios' . "\0" . 'idRole'];
        }
    ...
    public function getRoleDescricao()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRoleDescricao', []);

        return parent::getRoleDescricao();
    }
