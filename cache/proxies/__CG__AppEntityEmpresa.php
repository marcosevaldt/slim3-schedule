...
class Empresa extends \App\Entity\Empresa implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Empresa' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Empresa' . "\0" . 'nome', '' . "\0" . 'App\\Entity\\Empresa' . "\0" . 'endereco'];
        }
     ...
     * {@inheritDoc}
     */
    public function addEndereco($rua, $idCidade, $numero, $complemento, $bairro)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addEndereco', [$rua, $idCidade, $numero, $complemento, $bairro]);

        return parent::addEndereco($rua, $idCidade, $numero, $complemento, $bairro);
    }
